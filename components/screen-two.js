    ...
    <>
      <div className='bg-sky-700 w-full h-screen overflow-hidden flex justify-center '>
        <div className='w-9/12 flex items-center flex-col lg:flex-row'>
          <div className='lg:w-6/12 w-full lg:self-center self-start lg:pl-0 md:pl-16 pl-4 order-last lg:order-first'>
            <img
              src='./imgs/talk.svg'
              alr='download icon'
            ...
            <button className='bg-emerald-400 text-white  px-4 py-2 mt-10'>
              Pobierz aplikację
            </button>
          </div>
